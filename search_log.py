...
def generateReport(api, query, filename, twitter_app_auth):
    tweetCount = 0
    maxTweets = 10000000
    max_id = -1
    sinceId = None
...
def init(args):
    api = authenticateOnTwitter(args.consumer_key, args.secret_key, args.token_key, args.token_secret)
    ...
    generateReport(api, args.query, args.log_file, twitter_app_auth)
